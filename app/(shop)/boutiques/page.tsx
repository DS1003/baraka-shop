                            ...
                            >
                                <div className="relative h-48 md:h-64 w-full overflow-hidden">
                                    <div className="w-full h-full bg-[#1B1F3B] flex items-center justify-center">
                                        <MapPin className="w-12 md:w-16 h-12 md:h-16 text-primary/30" strokeWidth={1} />
                                ...
                                <div className="p-8 md:p-10 flex flex-col gap-4 md:gap-6">
                                    <div>
                                        <span className="text-[9px] md:text-[10px] font-black text-primary uppercase tracking-[0.2em] mb-2 block">{store.city}</span>
                                    ...
                                    <button className="w-full h-12 md:h-14 bg-gray-50 text-[#1B1F3B] rounded-xl md:rounded-2xl font-black text-[9px] md:text-[10px] uppercase tracking-widest hover:bg-primary hover:text-white transition-all mt-2 md:mt-4">
