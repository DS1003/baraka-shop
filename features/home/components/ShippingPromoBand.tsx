                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="relative overflow-hidden rounded-[2rem] bg-[#1B1F3B] p-10 flex flex-col justify-between min-h-[220px] group">
                        ...
                        <div className="relative z-10 flex items-center justify-between mt-6">
                            <p className="text-gray-400 text-sm max-w-[200px]">Sur toutes les commandes de plus de <span className="text-white font-bold">500.000 CFA</span></p>
                            <div className="px-6 py-2 bg-white/5 border border-white/10 rounded-full text-white text-[10px] font-black uppercase tracking-widest">
                                Code: EXPRESS24
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative overflow-hidden rounded-[2rem] bg-gray-50 border border-gray-100 p-10 flex flex-col justify-between min-h-[220px] group">
                        ...
                        <div className="relative z-10 flex flex-col gap-4">
                            ...
                            <h3 className="text-[#1B1F3B] text-2xl font-black uppercase tracking-tight">Garantie & Sérénité</h3>
                        </div>

                        <div className="relative z-10 flex items-center justify-between mt-6">
                            <p className="text-gray-500 text-sm max-w-[200px]">Service après-vente officiel et retours sous <span className="text-[#1B1F3B] font-black">7 jours</span></p>
