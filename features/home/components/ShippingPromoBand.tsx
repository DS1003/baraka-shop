    ...
    return (
        <section>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {/* Free Shipping Promo */}
                    <div className="relative overflow-hidden rounded-2xl md:rounded-[2.5rem] bg-[#1B1F3B] p-6 md:p-10 flex flex-col justify-between min-h-[220px] group">
                    ...
                    <div className="relative overflow-hidden rounded-2xl md:rounded-[2.5rem] bg-gray-50 border border-gray-100 p-6 md:p-10 flex flex-col justify-between min-h-[220px] group">
