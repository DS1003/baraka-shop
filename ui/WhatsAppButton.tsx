    ...
    return (
        <motion.a
            ...
            className={cn(
                ...
                "hover:shadow-[#25D366]/40 border border-white/20 group"
            )}
        ...
        >
            ...
            {/* Tooltip */}
            <div className="absolute right-full mr-4 bg-[#1B1F3B] text-white text-[10px] font-black uppercase tracking-widest px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap border border-white/10 shadow-xl">
                Besoin d'aide ?
            </div>
        </motion.a>
    )
